//Styles
// import "https://c0.wp.com/c/6.1.1/wp-includes/css/dashicons.min.css";
  ...
  return (
    <div className="sidebar">
      <aside id="secondary" class="widget-area" aria-label="Blog Sidebar">
        <section id="block-11" class="widget ">
          <h2 class="widget-title widget-title-af">Support</h2>
        </section>
        <section id="block-12" class="widget widget_block widget_media_image">
          <figure class="wp-block-image size-full sidebar-img-AF">
            <a
        ...
        <section id="block-16" class="widget widget_block">
          <h2 class="widget-title widget-title-af">Follow Us</h2>
        </section>
        ...
        <section id="block-9" class="widget widget_block">
          <h2 class="widget-title widget-title-af">Menu</h2>
        </section>
        ...
        <section id="block-18" class="widget widget_block">
          <h2 class="widget-title widget-title-af">Last Five Posts</h2>
        </section>
        <section
          id="block-17"
          class="widget widget_block widget_recent_entries"
        >
          <ul class="wp-block-latest-posts__list wp-block-latest-posts">
            {/* <!-- https://awesomefriday.ca/wp-json/wp/v2/posts?per_page=5 --> */}

            <li>
              <a
                class="wp-block-latest-posts__post-title"
                href="https://awesomefriday.ca/2022/12/podcast-the-banshees-of-inisherin-avatar-the-way-of-water/"
                sl-processed="1"
              >
                Podcast: The Banshees of Inisherin &amp; Avatar: The Way of
                Water (&amp; Elvis, too) (w/ Guest Host Rachel Ho)
              </a>
            </li>
            <li>
              <a
                class="wp-block-latest-posts__post-title"
                href="https://awesomefriday.ca/2022/12/podcast-diaspora-polaris-whistler-film-festival/"
                sl-processed="1"
              >
                Podcast: Diaspora, Polaris, &amp; The 2022 Whistler Film
                Festival (w/ Guest Host Rachel Ho)
              </a>
            </li>
            <li>
              <a
                class="wp-block-latest-posts__post-title"
                href="https://awesomefriday.ca/2022/12/podcast-something-in-the-dirt-emancipation/"
                sl-processed="1"
              >
                Podcast: Something in the Dirt &amp; Emancipation (w/ Guest Host
                Rachel Ho)
              </a>
            </li>
            <li>
              <a
                class="wp-block-latest-posts__post-title"
                href="https://awesomefriday.ca/2022/12/podcast-troll-guillermo-del-toros-pinocchio/"
                sl-processed="1"
              >
                Podcast: Troll &amp; Guillermo del Toro’s Pinocchio
              </a>
            </li>
            <li>
              <a
                class="wp-block-latest-posts__post-title"
                href="https://awesomefriday.ca/2022/11/podcast-andor-spirited-guardians-of-the-galaxy/"
                sl-processed="1"
              >
                Podcast: Andor (reprise), Spirited, &amp; The Guardians of the
